...
Suite sources include player analytical, headless combat, enemy median DPS, production drops, sensitivity maximum impact, best legal affix objective delta, loot upgrades per 100 kills, and crafting success rate. Choose small sample counts in a suite you intend to recapture frequently. Drilldown currently uses the scenario name and suite editor; direct click-through to source tabs is not implemented. Snapshots do not retain enormous per-fight traces.
