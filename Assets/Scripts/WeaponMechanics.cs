...
public sealed class RageState:MonoBehaviour
{
    ...
    public void GainFromDamageDealt(float damage,float targetMaximumLife){if(!IsSupportedWeapon||damage<=0)return;Gain(5+Mathf.Min(10,Mathf.Floor(damage/Mathf.Max(1,targetMaximumLife)*50)));}
