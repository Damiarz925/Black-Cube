...
public static class BaselineVerificationRunner
{
    ...
    public static void BuildStep16Windows()
        => BuildWindowsAt("Builds/Step16Windows/BlackCube.exe", "Logs/Step16WindowsBuild.txt");
    public static void BuildStep17Windows()
        => BuildWindowsAt("Builds/Step17Windows/BlackCube.exe", "Logs/Step17WindowsBuild.txt");
    public static void BuildStep18Windows()
        => BuildWindowsAt("Builds/Step18Windows/BlackCube.exe", "Logs/Step18WindowsBuild.txt");
    public static void BuildStep18_5Windows()
        => BuildWindowsAt("Builds/Step18_5Windows/BlackCube.exe", "Logs/Step18_5WindowsBuild.txt");
    public static void BuildStep18_6Windows()
        => BuildWindowsAt("Builds/Step18_6Windows/BlackCube.exe", "Logs/Step18_6WindowsBuild.txt");
    public static void BuildStep19Windows()
        => BuildWindowsAt("Builds/Step19Windows/BlackCube.exe", "Logs/Step19WindowsBuild.txt");
    public static void BuildStep20Windows()
        => BuildWindowsAt("Builds/Step20Windows/BlackCube.exe", "Logs/Step20WindowsBuild.txt");
    public static void BuildPassiveTreeV3Windows()
        => BuildWindowsAt("Builds/PassiveTreeV3Windows/BlackCube.exe", "Logs/PassiveTreeV3WindowsBuild.txt");
    public static void BuildTooling1Windows()
        => BuildWindowsAt("Builds/Tooling1Windows/BlackCube.exe", "Logs/Tooling1WindowsBuild.txt");
    public static void BuildTooling2Windows()
        => BuildWindowsAt("Builds/Tooling2Windows/BlackCube.exe", "Logs/Tooling2WindowsBuild.txt");
    public static void BuildTooling3Windows()
